...
Prepare an AWS account with permissions for Budgets, EC2, RDS, S3, IAM, Secrets Manager or SSM Parameter Store, CloudWatch, SNS, CloudFront, and WAF. Locally, install Git and Java 17, and confirm the Maven Wrapper can build TechBlog.
